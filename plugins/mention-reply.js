    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "INFINITY-MD 🥀",
            body: config.DESCRIPTION || "POWERED BY SIRIUS TECH 🤌",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/ys954m.jpg", // Static image URL
            sourceUrl: "https://wa.me/message/50939103464",
